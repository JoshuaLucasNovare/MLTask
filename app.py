...
userinput.append(st.sidebar.number_input('Radius Mean',format="%.6f"))
userinput.append(st.sidebar.number_input('Texture Mean',format="%.6f"))
userinput.append(st.sidebar.number_input('Perimeter Mean',format="%.6f"))
userinput.append(st.sidebar.number_input('Area Mean',format="%.6f"))
userinput.append(st.sidebar.number_input('Smoothness Mean',format="%.6f"))
userinput.append(st.sidebar.number_input('Compactness Mean',format="%.6f"))
userinput.append(st.sidebar.number_input('Concavity Mean',format="%.6f"))
userinput.append(st.sidebar.number_input('Concave points Mean',format="%.6f"))
userinput.append(st.sidebar.number_input('Symmetry Mean',format="%.6f"))
userinput.append(st.sidebar.number_input('Fractal Dimension Mean',format="%.6f"))
userinput.append(st.sidebar.number_input('Radius Standard Error',format="%.6f"))
userinput.append(st.sidebar.number_input('texture Standard Error',format="%.6f"))
userinput.append(st.sidebar.number_input('Perimeter Standard Error',format="%.6f"))
userinput.append(st.sidebar.number_input('Area Standard Error',format="%.6f"))
userinput.append(st.sidebar.number_input('Smoothness Standard Error',format="%.6f"))
userinput.append(st.sidebar.number_input('Compactness Standard Error',format="%.6f"))
userinput.append(st.sidebar.number_input('Concavity Standard Error',format="%.6f"))
userinput.append(st.sidebar.number_input('Concave points Standard Error',format="%.6f"))
userinput.append(st.sidebar.number_input('Symmetry Standard Error',format="%.6f"))
userinput.append(st.sidebar.number_input('Fractal Dimension Standard Error',format="%.6f"))
userinput.append(st.sidebar.number_input('Radius Worst',format="%.6f"))
userinput.append(st.sidebar.number_input('Texture Worst',format="%.6f"))
userinput.append(st.sidebar.number_input('Perimeter Worst',format="%.6f"))
userinput.append(st.sidebar.number_input('Area Worst',format="%.6f"))
userinput.append(st.sidebar.number_input('Smoothness Worst',format="%.6f"))
userinput.append(st.sidebar.number_input('Compactness Worst',format="%.6f"))
userinput.append(st.sidebar.number_input('Concavity Worst',format="%.6f"))
userinput.append(st.sidebar.number_input('Cncave points Worst',format="%.6f"))
userinput.append(st.sidebar.number_input('Symmetry Worst',format="%.6f"))
userinput.append(st.sidebar.number_input('Fractal Dimension Worst',format="%.6f"))
